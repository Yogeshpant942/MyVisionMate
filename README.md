...
**MyVisionMate** is a powerful **100% Kotlin-based** vision AI application that brings intelligent visual recognition directly to your Android device. Whether you're analyzing images, extracting information, or leveraging computer vision capabilities, MyVisionMate provides an intuitive and high-performance platform for your visual intelligence needs.

Built entirely with **Kotlin**, featuring a robust **Kotlin backend** and modern **Jetpack Compose frontend**, MyVisionMate demonstrates the full potential of Kotlin across the entire application stack.
...
- **Testing**: JUnit4/5, Espresso, MockK
...
```
[Home Screen] [Camera Screen] [Results Screen] [Gallery Screen]
```
